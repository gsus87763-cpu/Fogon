...
-- =====================================================================
-- A partir de aquí: contenido de migracion_v2.sql, integrado para que
-- una instalación NUEVA (import completo de este archivo) ya incluya
-- todo. Si vas a aplicar esto sobre una base EXISTENTE, no uses esta
-- copia: corre migracion_v2.sql por separado (es el mismo contenido).
-- =====================================================================
